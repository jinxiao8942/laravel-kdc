...
<div id="jobs-container">
    ...
    <div class="referPop" style="display: none;">
        <div class="close">X</div>
        <div class="info">
            <p>Send this job to someone you know</p>
                {{ Form::open(['url' => 'jobs/share', 'role' => 'form']) }}
        
        	<fieldset>
                <div class="row">
                    <div class="col-xs-12">
                        <input type="text" class="form-control" placeholder="Your name *" required="" name="name_1">
                    </div>
		    <div class="col-xs-12">
                        <input type="text" class="form-control" placeholder="Your email address *" required="" name="email_1">
                    </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <input type="text" class="form-control" placeholder="Your friends name *" required="" name="name_2">
                    </div>
		    <div class="col-xs-12">
                        <input type="text" class="form-control" placeholder="Your  friends email address *" required="" name="email_2">
                    </div>
                </div>
                
                <textarea class="form-control" placeholder="Message *" name="share_message"></textarea>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <section id="jobs" class="col-md-9 col-md-push-3">
                ...
                <div id="job-count">{{ count($jobs) }}<span> Jobs</span></div>
                
                    <div id="noJobs">
                        <h3>There are currently no jobs that match your search criteria</h3>
                        <p>Here are the latest jobs from KDC Resource</p>
                        <div id="recommended-jobs" class="widget visible-md visible-sm visible-lg">
                        ...
                        <div class="slide">
                            <div class="vacancyUpper">
                                ...
                                <a href="{{ URL::to('jobs/'.$job->JobId.'-'.Str::slug($job->JobTitle)) }}?ref=details">
                                    <p>{{ $job->JobTitle }}
                                    </p>
                            ...
                            <div class="vacancyDetails">
                                        ...
                                        <span class="vacancyDetail">
                                            ...
                                            @elseif ($job->Salary)
                                                @if($job->Salary == '.00')
                                                    <strong>Negotiable</strong>
                                                @else
                                                    <strong>{{$job->CurrencySymbol}}{{number_format($job->Salary, 0, $locale['decimal_point'], $locale['thousands_sep'])}}</strong> 
                                                @endif
                                            @else
                                                <strong>Negotiable</strong>
                                            @endif
                                ...
                                <a href="{{ URL::to('jobs/'.$job->JobId.'-'.Str::slug($job->JobTitle)) }}?ref=apply" class="applyButton"><span>APPLY</span> FOR JOB<span class="caret right"></span></a>
                                
                                <div class="vacancyTabs">
                                    <a href="{{ URL::to('jobs/'.$job->JobId.'-'.Str::slug($job->JobTitle)) }}?ref=details">DETAILS</a>
                                    <a href="{{ URL::to('jobs/'.$job->JobId.'-'.Str::slug($job->JobTitle)) }}?ref=refer">REFER</a>
                                    <span>SHARE
                                    
                                        
                                        
                                        <!--<a href="https://twitter.com/home?status={{ $job->JobTitle }} {{ URL::to('jobs/'.$job->JobId.'-'.Str::slug($job->JobTitle)) }} via @kdcresource">-->
                                        ...
                                        <div class="fb-share-button" data-href="{{ URL::to('jobs/'.$job->JobId.'-'.Str::slug($job->JobTitle)) }}" data-type="link">FB LINK
                                        </div>
                                    </span>
                                </div>
                            </div>
                ...
                -->
                                    ...
                                    @if ($job->PayRate)
                                        ...
                                        @elseif ($job->Salary)
                                            @if($job->Salary == '.00')
                                                <strong>Negotiable</strong>
                                            @else
                                                <strong>{{$job->CurrencySymbol}}{{number_format($job->Salary, 0, $locale['decimal_point'], $locale['thousands_sep'])}}</strong> per {{ $job->ValueName }}
                                            @endif
                                        @else
                                            <strong>Negotiable</strong>
                                        @endif
                    ...
                    <footer class="job-tools">
                        ...
                        <div class="row">
                            ...
                            <!--<div class="job-apply job-social col-md-5">
                                
                               <!-- <a href="#">
                                    
                                    Apply <span>for this job <img src="{{ URL::asset('/img/icon-apply-arrow-down.png') }}" />
                    ...
                    <ul>
                        <li class="sector">
                            ...
                            <div class="toggle">
                                ...
                                @foreach($sectors as $key => $sector)
                                    ...
                                    <?php 
                                    if(isset($_GET['sector'])) {$sectors = Input::get('sector');} else{$sectors=array();} ?>
                                    <?php $checked = ''; ?>
                                    ...
                                    <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="sector[]" value="{{ $sector->SectorId }}" <?php echo $checked; ?>>
                        ...
                        <div class="toggle">
                                ...
                                @foreach($job_types as $key => $job_type)
                                    ...
                                    <?php 
                                    if(isset($_GET['job_type'])) {$job_types = Input::get('job_type');} else{$job_types=array();} ?>
                                    <?php $checked = ''; ?>
                                    @foreach($job_types as $id)
                                        @if($id == $key) 
                                            <?php $checked = 'checked'; ?>
                                        @endif
                                    @endforeach
                                    ...
                                    @if($key == 4 || $key == 6)
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" name="job_type[]" value="{{ $key }}" <?php echo $checked; ?>>
                                                <span class="fakeCheck"></span>
                                                {{ $job_type }}
                                            </label>
                                        </div>
                        ...
                        <li class="location">
                            ...
                            <div class="toggle">
                                ...
                                <?php 
                                    if(isset($_GET['location'])) {$locationsa = Input::get('location');} else{$locationsa=array();} ?>
                                    <?php $checked = ''; ?>
                                    @foreach($locationsa as $id)
                                    ...
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="location[]" value="{{ $location->LocationId }}"  <?php echo $checked; ?>>
                                            <span class="fakeCheck"></span>
